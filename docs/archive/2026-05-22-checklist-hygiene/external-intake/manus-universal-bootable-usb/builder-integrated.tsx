...
import { ScrollView, Text, View, TouchableOpacity, ActivityIndicator, FlatList, Switch } from 'react-native';
import { ScreenContainer } from '@/components/screen-container';
import { useUSBDevices, useBuildRecipe, useStartUSBBuild, useBuildProgress } from '@/hooks/use-phoenix-api';
...
export default function USBBuilderIntegratedScreen() {
  ...
  const { progress } = useBuildProgress(buildId);

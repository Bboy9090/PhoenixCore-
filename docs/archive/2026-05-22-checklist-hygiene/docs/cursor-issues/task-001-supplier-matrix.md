...
## Acceptance Criteria
- [ ] Every shipped feature mapped to a capability
- [ ] Every dependency tagged: runtime vs build-time
- [ ] Replacement module + milestone assigned to each runtime dependency
